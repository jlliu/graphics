...
function onStartFrame(t, state) {
    ...
    //Set sphere
    gl.uniform3fv(state.uShapes[0].center , [-.0,0.5,-1]);
    gl.uniform1f(state.uShapes[0].shapeSize   , .56);
    ...
    //Set material 5
    gl.uniform3fv(state.uMaterialsLoc[4].ambient , [.01,.1,.1]);
    ...
    gl.uniform3fv(state.uMaterialsLoc[4].reflect  ,[0.9,0.9,.9]);
    gl.uniform3fv(state.uMaterialsLoc[4].transparent,[0.,0.,0.]);
     gl.uniform1f(state.uMaterialsLoc[4].indexOfRefraction   ,1.2);
